...
- now you can interrupt devel mode by ctrl+C and start as a standalone service:
  ```sh
  # mfw start example-2
	-	starting example-2:start
	[ok]	example-2:start started
  ```
- check status
  ```sh
  # mfw status
  	-	checking example-2:status
  
    SERVICE    VERSION   PID    CPU    MEM    Comment
   --------------------------------------------------------
    example-2  1.0.1     10431  0.00   41
   --------------------------------------------------------
    1 / 0                       0 %    41 Mb
